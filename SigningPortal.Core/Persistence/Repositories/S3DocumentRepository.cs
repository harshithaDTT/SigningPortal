...
{
    public class S3DocumentRepository : GenericRepository<FileStorage>, IS3DocumentRepository
    {
        public S3DocumentRepository(IMongoDbSettings settings) : base(settings)
        {
        }
